...
namespace MedicalResearchApplication
{
    ...
    class DiseaseManager
    {
        ...
        static Symptom sym = new Symptom();
        ...
        public static void AddSymptom()
        {
            ...
            Console.WriteLine("Diseses are:" + dis.DiseaseName);
        ...
        public static void CheckPatient()
        {
            ...
            Console.WriteLine("-------------------------------------------------");
            Console.WriteLine("Enter the Symptom");
            string checksymptom = Console.ReadLine();
            Console.WriteLine("-------------------------------------------------");
            if (sym.SymptomName==checksymptom)
            {
                Console.WriteLine("Disease is:" + dis.DiseaseName);
            }
        }
